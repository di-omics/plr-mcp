...
PCR_ENRICHMENT_PCR1_SCRIPT = "01_pcr_enrichment_round1_mastermix_col1.py"
...
def pcr_enrichment_round1_script_path() -> str:
    return os.path.join(starlab_dir(), PCR_ENRICHMENT_PCR1_SCRIPT)
...
async def run_pcr_enrichment_round1(
    ...
    mod = _load_script(PCR_ENRICHMENT_PCR1_SCRIPT)
    ...
    return {
        ...
        "script": PCR_ENRICHMENT_PCR1_SCRIPT,
        "backend": backend,
        "mode": mode,
