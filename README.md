...
| Tool            | What it does |
|-----------------|--------------|
| `setup_deck`    | Build the liquid handler on a liquid handlerLet deck and place a tip rack and a 96-well plate. Call this first. |
...
With that set, `setup_deck` uses PyLabRobot's real liquid handler `STAR` backend. The
